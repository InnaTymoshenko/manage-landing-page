...
const About = (props: Props) => {
	return (
		<section className="w-full lg:h-[70vh] sx:min-h-[90vh]  flex lg:flex-row sx:flex-col justify-between gap-20 container">
			...
			<div className="lg:w-[50%] sx:w-full lg:h-full sx:h-[30rem] gap-2 flex flex-col justify-between">
				{services.map((s, i) => {
					return (
